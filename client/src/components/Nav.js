...
export default function Nav() {
    ...
    return (
        <nav className="chat-box-nav" style={{backgroundColor: "#0B666A", display: "flex", justifyContent: "space-between", height: "5%", borderBottom: "1px solid #ffffff"}}>
            ...
            <i onClick={() => {setPromptOptionsIsVisible(!promptOptionsIsVisible); setBlurDivIsVisible(!blurDivIsVisible)}} class="fa-solid fa-sliders" style={{fontSize: "30px", color: "#ffffff", boxSizing:"border-box", padding: "10px"}}></i>
        </nav>
    )
}
